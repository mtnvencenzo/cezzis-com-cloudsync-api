...
class TestInitializeOtel:
    ...
    @patch("cezzis_com_cloudsync_api.application.behaviors.otel.initialize_otel.atexit.register")
    @patch("cezzis_com_cloudsync_api.application.behaviors.otel.initialize_otel.get_otel_options")
    @patch("cezzis_com_cloudsync_api.application.behaviors.otel.initialize_otel.initialize_otel")
    @patch("cezzis_com_cloudsync_api.application.behaviors.otel.initialize_otel.version")
