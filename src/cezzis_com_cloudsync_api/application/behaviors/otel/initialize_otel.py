...
def initialize_opentelemetry() -> None:
    ...
    # Make sure to shutdown and gracefully flush the telemetry data on exit
    ...
    initialize_otel(
        settings=OTelSettings(
            ...
            service_version=version("cezzis_com_cloudsync_api"),
    ...
    # Add ProbeLoggingFilter to all handlers on the root logger so probe requests are silenced
